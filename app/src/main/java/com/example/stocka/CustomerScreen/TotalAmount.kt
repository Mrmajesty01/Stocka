...
fun TotalAmountOwing(
    ...
    if(openDialog){
        AlertDialog(
            ...
            title = {
                Text(text = "View Total Amount Owing Customers")
            },
            ...
            text = {
                Column {
                    ...
                    OutlinedTextField(
                        ...
                        label = { Text("Enter PIN To View Amount Owing Customers") },
    ...
    Card(
        ...
        modifier = Modifier.fillMaxWidth()
            ...
            if (totalAmountOwingHidden) {
                openDialog = true
            }

            else {
                totalAmountOwingHidden = true
            }
        ...
        Box(
            ...
            Text(
                text = if (totalAmountOwingHidden) "*****" else formattedAmount,
